        ...
        {filteredTasks.length > 0 && (
          <div className="flex items-center justify-center gap-4 pt-4">
            <button
              ...
              className="flex items-center gap-1 rounded-lg border border-transparent hover:border-[var(--primary)] px-4 py-2 font-medium text-sm hover:bg-gray-600 disabled:cursor-not-allowed disabled:opacity-50"
              type="button"
            >
